...
@Component({
  selector: 'sample-thf-combo-heroes-reactive-form',
  templateUrl: './sample-thf-combo-heroes-reactive-form.component.html'
})
export class SampleThfComboHeroesReactiveFormComponent implements OnInit {
