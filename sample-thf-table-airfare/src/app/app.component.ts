...
@Injectable()
export class SampleThfTableAirfareService {
  ...
  getColumns(): Array<ThfTableColumn> {
    ...
    return [
      { property: 'status', type: 'label', width: '100px', labels: [
        { value: 'available', color: 'success', label: 'Available' },
        { value: 'reserved', color: 'warning', label: 'Reserved'},
        { value: 'closed', color: 'danger', label: 'Closed' }
      ]},
      { property: 'country', width: '150px'  },
      { property: 'destination', width: '150px' },
      { property: 'region', type: 'subtitle', width: '80px', subtitles: [
      ...
      { property: 'onBoardService', label: 'On Board Service', type: 'boolean', width: '150px', boolean: {
  ...
  getItems() {
    return [{
      ...
      status: 'available', region: 'Latin America',
      detail: [
        { package: 'Basic', tour: 'City tour by public bus and visit to the main museums.', time: '20:10:10', distance: '1000' },
        { package: 'Intermediary', tour: 'City tour by van and guided visit to the main museums.', time: '09:15:19', distance: '2000' },
        { package: 'Complete', tour: 'VIP city tour, music show with dinner and guided tour to the main museums.',
          time: '07:10:20', distance: '3000' }
      ]
    },
    {
      ...
      status: 'closed', region: 'Alps',
      detail: [
        { package: 'Basic', tour: 'City tour by public bus and visit to the main museums.', time: '10:15:10', distance: '4800'  },
        { package: 'Intermediary', tour: 'City tour by van and guided visit to the main museums.', time: '22:15:10', distance: '11000' },
        { package: 'Complete', tour: 'VIP city tour, music show with dinner and guided tour to the main museums.',
          time: '10:15:10', distance: '1000' }
      ]
    },
    {
      id: 40670, initials: 'SN', country: 'Senegal', value: 3200.00, date: '2017-11-22',
      returnDate: '2018-12-01', class: 'Economic', onBoardService: false, destination: 'Dakar', airline: 'Iberia',
      status: 'closed', region: 'Western Africa'
    },
    {
      ...
      status: 'closed', region: 'Mediterranean'
    },
    {
      id: 48999, initials: 'RU', country: 'Russia', value: 6700.00, date: '2019-01-17',
      returnDate: '2019-02-20', class: 'First Class', onBoardService: true, destination: 'Moscow', airline: 'Lufthansa',
      status: 'reserved', region: 'Caucasus'
    },
    {
      ...
      status: 'reserved', region: 'North America'
    },
    {
    ...
    },
    {
      ...
      status: 'available', region: 'Latin America',
      detail: [
        { package: 'Basic', tour: 'City tour by public bus and visit to the main museums.', time: '12:10:10', distance: '2200' },
        { package: 'Intermediary', tour: 'City tour by van and guided visit to the main museums.', time: '11:10:10', distance: '1500' },
        { package: 'Complete', tour: 'VIP city tour, music show with dinner and guided tour to the main museums.',
          time: '16:10:10', distance: '1800' }
      ]
    },
    {
      ...
      status: 'reserved', region: 'British Isle',
    },
    {
      id: 23445, initials: 'ZA', country: 'South Africa', value: 1900.00, date: '2018-12-10',
      returnDate: '2018-12-25', destination: 'Cape Town', class: 'Economic', onBoardService: false, airline: 'South African Airways',
      status: 'available', region: 'Southern Africa'
    },
    {
      ...
      status: 'reserved', region: 'Australasia'
    },
    {
      ...
      status: 'available', region: 'East Asia'
    },
    {
    ...
    },
    {
      ...
      status: 'available', region: 'British Isle',
    },
    {
      ...
      status: 'available', region: 'North America'
    },
    {
      id: 93800, initials: 'IS', country: 'Iceland', value: 6300.00, date: '2018-10-12',
      returnDate: '2018-10-27', destination: 'Reykjavík', class: 'Economic', onBoardService: false, airline: 'Star Alliance',
      status: 'available', region: 'Nordics'
    },
    {
      id: 34239, initials: 'DE', country: 'Germany', value: 3070.50, date: '2018-10-07',
      returnDate: '2018-10-20', destination: 'Berlin', class: 'Executive', onBoardService: true, airline: 'LATAM',
      status: 'available', region: 'Danube'
    },
    {
      ...
      status: 'reserved', region: 'Latin America'
    }];
