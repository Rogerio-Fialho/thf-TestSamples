...
@Injectable()
export class SampleThfTableTransportService {
  ...
  getColumns(): Array<ThfTableColumn> {
    return [
      ...
      { property: 'status', type: 'label', width: '8%', labels: [
        { value: 'delivered', color: 'success', label: 'Delivered' },
        { value: 'transport', color: 'warning', label: 'Transport' },
        { value: 'production', color: 'danger', label: 'Production' }
      ]}
    ];
  }
